...
fn main() {
    ...
    assert(is_alphabetic(ref your_character) || !is_alphabetic(ref your_character), 'error primitive_types2');
    assert(is_numeric(ref your_character) || !is_numeric(ref your_character), 'error primitive_types2');
}
